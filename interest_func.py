...
def add_a_row_to_transaction_history(date: Timestamp,  asset: str, net_change: float, house: str, comment: str, transaction_history: DataFrame):
    """
...
def define_empty_transaction_history():
    ...
    """
    return DataFrame(columns=['Date','asset', 'net_change', 'house','comment'])
